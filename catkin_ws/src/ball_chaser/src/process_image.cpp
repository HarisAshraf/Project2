...
void process_image_callback1(const sensor_msgs::Image img)
{
...
// This callback function continuously executes and reads the image data
void process_image_callback3(const sensor_msgs::Image img)
{
...
int main(int argc, char** argv)
{
    ...
    ros::Subscriber sub1 = n.subscribe("/camera/rgb/image_raw", 10, process_image_callback3);
